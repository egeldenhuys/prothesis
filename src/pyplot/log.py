...
plt.plot(csv2[:-1,0], csv2[:-1,1], "bo", label="Single Buffer")
plt.plot(csv[:-1,0], csv[:-1,1], "ro", label="Single No Buffer")

plt.plot(csv2[:-1,0], csv2[:-1,2], "b-", label="Average Buffer")
plt.plot(csv[:-1,0], csv[:-1,2], "r-", label="Average No Buffer")
